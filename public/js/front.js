...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api/post?page=".concat(page)).then(function (result) {
        _this.posts = result.data.data;
        _this.current = result.data.current_page;
        _this.last = result.data.last_page;
      });
    },
    ...
    getPrev: function getPrev(number) {
      if (number > 1) {
        this.current--;
        return this.current;
      }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getData: function getData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api".concat(this.$route.path)).then(function (res) {
        _this.post = res.data;
      });
    }
  },
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", { staticClass: "container text-center" }, [
      _c("h1", [_vm._v("This is the")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, autem delectus eveniet sunt porro expedita id magni, a distinctio ab fugit vero dignissimos quidem. Voluptas nam vero hic pariatur impedit."
        ),
      ]),
    ])
  },
          ...
          _c(
            ...
            [
              ...
              _c(
                "router-link",
                {
                  staticClass: "btn btn-primary w-50 my-2 mx-3",
...
var render = function () {
  ...
  return _vm.post
    ? _c("div", { staticClass: "container text-center" }, [
        _c("h1", [_vm._v(_vm._s(_vm.post.post_title))]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "my-2" },
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "router-link",
        { staticClass: "badge badge-success", attrs: { to: { name: "home" } } },
...
/* harmony import */ var _routes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./routes.js */ "./resources/js/routes.js");
 // va direttamente a puntare nella cartella node-modules.

 // prende il componente App.vue nella cartella views
...
/* harmony import */ var _pages_SinglePost__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/SinglePost */ "./resources/js/pages/SinglePost.vue");
 // import di vue dalle dependencies

 // import di vue-router
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  mode: 'history',
  // in pratica permette al browser di poter utilizzare le freccette di navigazione
  routes: [{
    path: '/',
    name: 'home',
...
/* harmony default export */ __webpack_exports__["default"] = (router); // default almeno qunado importo non devo specificare cosa;
...
module.exports = __webpack_require__(/*! C:\Progetti\BOOLEAN\LARAVEL\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
